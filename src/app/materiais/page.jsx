        ...
        <>
            <div className="p-2 grid justify-around grid-rows-4 grid-flow-col gap-4">
                {books.map((book, index) => (
                    <div className="w-full max-w-sm border rounded-lg shadow bg-secondary" key={index}>
                        ...
                        <div className="px-5 pb-5">
                            ...
                            <div className="flex items-center justify-between">
                                <a href="#" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 w-full">Ver Mais</a>
                            </div>
                        </div>
                    </div>
